...
if (typeof CanvasRenderingContext2D !== 'undefined') {
   ...
   * @param {number} r size, width and height of the square
   */
  CanvasRenderingContext2D.prototype.pentagon = function (x, y, r) {
    this.beginPath();
    for(var i = 0; i < 5; i ++){
      var angle = (i / 5) * Math.PI * 2 - (Math.PI / 2);
      this.lineTo(Math.cos(angle) * r + x, Math.sin(angle) * r + y);
    }
    this.closePath();
  };
   ...
   */
  CanvasRenderingContext2D.prototype.parallelogram = function (x, y, w, h) {
    this.beginPath();
    
    this.lineTo(x - w, y + h);
    this.lineTo(x + w * 0.5, y + h);
    this.lineTo(x + w, y - h);
    this.lineTo(x - w * 0.5, y - h);
   ...
   * @param {number} h vertical height
   */
  CanvasRenderingContext2D.prototype.squaredCircle = function (x, y, w, h) {
    var kappa = .5522848,
      ox = (w / 2) * kappa, // control point offset horizontal
      oy = (h / 2) * kappa, // control point offset vertical
      xe = x + w,           // x-end
   ...
   * 
   */
  CanvasRenderingContext2D.prototype.squaredTriangleDown = function (x, y, w, h) {
    this.beginPath();
